	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" placeholder="Buscar por nombre" />') :
			  sSearchStr==="" ? '<input type="text" placeholder="Buscar por nombre" />' : sSearchStr+' <input type="text" placeholder="Buscar por nombre" />';
