	...
	<div id="panel">
		<div class="content">
			...
			<form class="row-fluid form-signin" id="form-login" action="<%=request.getContextPath() %>/j_spring_security_check" method="post" AUTOCOMPLETE="off">
				...
				<input class="field" type="text" name="j_username" id="username" class="textInput" placeholder="usuario" autocomplete="off">
				<label class="grey" for="pwd">Clave:</label>
				<input class="field" type="password" name="j_password" id="password" class="textInput" placeholder="clave" autocomplete="off">
